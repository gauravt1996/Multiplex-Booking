...
<title>User Registration-OMTB</title>
<meta charset="utf-8">
...
<div class="page">
            ...
            <nav class="nav">
              <ul data-type="navbar" class="sf-menu">
                ...
                <!--<li><a href="#">About</a>
                 ...
                 <li class="active"><a href="UserInterfaces.jsp">User Account</a>
                </li>
               <!-- <li><a href="#">FAQS</a>
                </li>
      ...
      -->
      <main>
        <section class="camera_container hr">
          <div id="camera" class="camera_wrap">
            <div data-src="images/img/11.jpg">
        ...
        <section class="well1">
          <div class="container">
            <div class="row">
              <div class="grid_4">
                <h2>About</h2><img src="images/img/10.jpg" alt="">
                <p>About Theater</p>
              </div>
              <div class="grid_4">
                <h2>COMING SOON</h2>
                ...
                <marquee behavior="scroll" height="260" direction="up" scrollamount="4" onmouseover="this.stop();" onmouseout="this.start();">
              ...
              <div class="grid_4">
                <div class="info-box">
                  <h2 class="fa-user">User Interface</h2>
                  <hr>
                  <form action="UserSubmit.jsp">
<center>
<table border="2">
<input type="text" name="uname" id="TextBox1" placeholder="Enter User Name">
<input type="number" name="umob" id="TextBox1" placeholder="Enter User Mobile">
<input type="email" name="uemail" id="TextBox1" placeholder="Enter User Email">
<input type="text" name="ulid" id="TextBox1" placeholder="Enter User Login ID">
<input type="password" name="upass" id="TextBox2" placeholder="Enter User Login Password">
<input type="submit" class="btn">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" class="btn">
      ...
      <footer>
        <section>
          <div class="container">
            <div class="copyright">Designed By:-  Ferman Naqvi & Santosh Punjabi</div>
          </div>
        </section>
      </footer>
    </div>
