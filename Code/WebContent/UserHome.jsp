          ...
          <div class="container">
            <nav class="nav">
              <ul data-type="navbar" class="sf-menu">
                <li><a href="DisplayCity.jsp" target="aa">Cities</a></li>
                <li><a href="DisplayMyBooking.jsp" target="aa">My Booking</a></li>
				
			<!-- 
				<li><a href="SearchTheater.jsp" target="aa">Search Theater</a></li>
				<li><a href="SearchMovie.jsp" target="aa">Search Movie</a></li>
			 -->
				<li><a href="ChangePasswordInterfaces.jsp" target="aa">Change Password</a></li>
                <!--<li><a href="#">About</a>
                   <ul>
      ...
      <main>
        ...
        <section class="well1">
          <div class="container">
            <div class="row">
              <div class="grid_8">
                <h4 style="background-color: #2E9AFE; color:white; padding:10px;">Welcome: <%= ulid %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Login Time: <%= utime%></h4>
                <div style="border:2px solid #2E9AFE; padding:20px;">
                <iframe name="aa" src=DisplayCity.jsp width="100%" id="myFrame" scrolling="yes" frameborder="0" onload="sizeFrame('myFrame')" ></iframe></div>
              </div>
               <div class="grid_4">
                <h4></h4>
             <!-- <p>Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
              ...
              <div class="grid_4">
                <div class="info-box">
                  ...
                  <ul class="marked-list">
                  <li><font color="white"><a href="#">2016 THE END - 4 NOV 2016</a></font></li>
