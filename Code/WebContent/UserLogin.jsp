            ...
            <nav class="nav">
              <ul data-type="navbar" class="sf-menu">
                ...
                <!--<li><a href="#">About</a>
                 ...
                 <li><a href="UserInterfaces.jsp">User Account</a>
                </li>
               <!-- <li><a href="#">FAQS</a>
                </li>
        ...
        <section class="well1">
          <div class="container">
            <div class="row">
              ...
              <div class="grid_4">
                <div class="info-box">
                  <h2 class="fa-user">User Login</h2>
                  <hr>
<form action="UserChkLogin.jsp">
<center>

<input type="text" name="ulid" id="TextBox1" placeholder="Enter Login ID"><br><br>
<input type="password" name="upass" id="TextBox2" placeholder="Password">
<input type="submit" value="Login" class="btn">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" class="btn">

</center>
</form>
                     <hr>
                <h3><a href="UserInterfaces.jsp">New User</a></h3>
               <h3><a href="TheaterLogin.jsp">Theater Login</a></h3>
                   <dl>
                    <dt><center></center></dt>
                  </dl>
                </div>
